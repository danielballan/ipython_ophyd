from ophyd.controls import ProsilicaDetector, EpicsSignal, EpicsScaler, SkepticalSignal
...
trans_diode = SkepticalSignal('XF:05IDA{IM:1}Cur:I0-I', rw=False, name='trans_diode')
fluor_diode = SkepticalSignal('XF:05IDA{IM:1}Cur:I1-I', rw=False, name='fluor_diode')
trans_diode_old = EpicsSignal('XF:05IDA{IM:1}Cur:I0-I', rw=False, name='trans_diode')
fluor_diode_old = EpicsSignal('XF:05IDA{IM:1}Cur:I1-I', rw=False, name='fluor_diode')
